...
test_handle_wake_terminal_signal_clears_pause_tracking() {
  ...
  : > "$state/.finished-resurfaced-$watcher_key"
  ...
  [ ! -e "$state/.wedge-resurfaced-$watcher_key" ] || fail "terminal signal retained the wedge long-cadence marker"
  [ ! -e "$state/.finished-resurfaced-$watcher_key" ] || fail "terminal signal retained the finished-pane marker"
  FM_STATE_OVERRIDE="$state" handle_wake "stale: $win" "$state"
