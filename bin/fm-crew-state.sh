...
#      to reattach, not by escalating. The one reverse case: a terminal log
#      report (done/failed) that DISAGREES with a terminal run-step label
#      outranks it, because the log is the crew's own final report; the
#      superseded run verdict stays in the detail.
